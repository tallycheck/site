  ...
  function(require, exports, module) {
    ...
    class Search extends React.Component {
      ...
      shouldComponentUpdate(nextProps, nextState, nextContext) {
        var ps = this.state;
        var ns = nextState;
        if (!_.isEqual(nextProps, this.props) || !_.isEqual(ns, ps) || !_.isEqual(nextContext, this.context)) {
          return true;
        }
        return false;
      }
    ...
    var Actions = React.createClass({
      ...
      actionObj: function (actionName) {
        ...
        var actionText = EntityMsg["GRID_ACTION_" + actionName];
        return {
          name: actionName,
          uri: actionUri,
          text: actionText
      ...
      makeActionButton: function (actionObject, isEntityAction, icon) {
        ...
        var btn = (
          <button type="button" key={actionName}
                  className={"btn btn-default action-control" + isEntityAction ? "entity-action":""}
      ...
      render: function () {
        ...
        return (
          <div className="grid-action-group-container">
            <div className="action-group">{btns}</div>
          </div>
        );
      }
    });
